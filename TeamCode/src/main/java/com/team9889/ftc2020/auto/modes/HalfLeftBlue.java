...
@Autonomous(group = "Blue", name = "Half Left Blue", preselectTeleOp = "Teleop")
public class HalfLeftBlue extends AutoModeBase {
    Trajectory traj;
        ...
        switch (box) {
            ...
            case MIDDLE:
                traj = Robot.rr.trajectoryBuilder(new Pose2d(-63, 58, Math.toRadians(0)))
                        ...
                        .splineTo(new Vector2d(30, 53), Math.toRadians(-70))
                        .build();
                Robot.rr.followTrajectory(traj);
            ...
            case FAR:
                traj = Robot.rr.trajectoryBuilder(new Pose2d(-63, 58, Math.toRadians(0)))
                        .splineTo(new Vector2d(20, 62), Math.toRadians(0))
                        .splineTo(new Vector2d(42, 62), Math.toRadians(45))
                        .build();
                Robot.rr.followTrajectory(traj);
