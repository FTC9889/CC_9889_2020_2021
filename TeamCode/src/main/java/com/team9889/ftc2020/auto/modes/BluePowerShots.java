 ...
 */
@Autonomous(group = "Blue", name = "Blue Powershots", preselectTeleOp = "Teleop")
public class BluePowerShots extends AutoModeBase {
    Trajectory traj;
        ...
        switch (box) {
            case CLOSE:
                traj = Robot.rr.trajectoryBuilder(new Pose2d(-10, 13, Math.toRadians(15)))
                        ...
                        .splineTo(new Vector2d(17, 48), Math.toRadians(130))
                        .build();
                Robot.rr.followTrajectory(traj);
            ...
            case FAR:
                traj = Robot.rr.trajectoryBuilder(new Pose2d(-10, 13, Math.toRadians(-15)))
                        ...
                        .splineTo(new Vector2d(58, 48), Math.toRadians(90))
                        .build();
                Robot.rr.followTrajectory(traj);
