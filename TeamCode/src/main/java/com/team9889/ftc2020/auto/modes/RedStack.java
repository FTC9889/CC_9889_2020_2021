 ...
 */
@Autonomous(group = "Red", name = "Red Stack", preselectTeleOp = "Teleop")
public class RedStack extends AutoModeBase {
    Trajectory traj;
...
//                Robot.rr.followTrajectory(traj);
            ...
            case FAR:
                ...
                traj = Robot.rr.trajectoryBuilder(traj.end(), true)
                        ...
                        .splineTo(new Vector2d(-5, -38), Math.toRadians(180))
                ...
                traj = Robot.rr.trajectoryBuilder(traj.end(), true)
                        .lineToSplineHeading(new Pose2d(-25, -38, Math.toRadians(0)),
